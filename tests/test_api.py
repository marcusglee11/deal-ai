...
mp.setattr(service_account.Credentials, "from_service_account_file", lambda *a, **kw: MagicMock())
...
def test_process_deal(test_client):
    ...
    mp.setattr(routes, "list_drive_files", mock_list)
    mp.setattr(routes, "parse_drive_file", mock_parse)
